...
> 4. 功能强大，导入支持严格的单元格校验，导出支持公式,复杂表头和尾部设计,以及单元格样式自定义支持
> 5. 支持读取复杂Excel模板,替换变量输出Excel,变量用${}替代
>
### 导入细节
...
### 导出细节
1. 支持傻瓜式定义动态表头+表尾，如列标题的定义和尾部合计行定义,同事支持单元格公式
